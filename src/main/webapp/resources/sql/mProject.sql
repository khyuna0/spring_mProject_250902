...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."RESERVATION_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SYSTEM.RESERVATION (RID,MEMBERID,RLOCATION,R_ROOM,RDATE,RTIME) values (1,'lion99','이대점','101호','2025-09-05','10:00');
Insert into SYSTEM.RESERVATION (RID,MEMBERID,RLOCATION,R_ROOM,RDATE,RTIME) values (2,'lion99','이대점','103호','2025-09-05','14:00');
...
Insert into SYSTEM.MEMBERS (MEMBERID,MEMBERPW,MEMBERAGE,MEMBERDATE,MEMBERNAME,MEMBEREMAIL) values ('minor','minor123',15,to_date('25/09/04','RR/MM/DD'),'미성년','minor@abc.com');
